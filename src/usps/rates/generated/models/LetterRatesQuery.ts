...
export type LetterRatesQuery = {
     ...
     *
     */
    processingCategory: LetterRatesQuery.processingCategory;
     ...
     *
     */
    extraServices?: Array<910 | 911 | 930 | 931 | 934 | 940 | 941 | 955 | 957 | 985>;
    /**
     * The value of the item. Required for Insurance and Registered Mail.
     */
    itemValue?: number;
};
export namespace LetterRatesQuery {
    /**
     * * LETTERS
     *
     * To be eligible for mailing at the price for letters, a piece must be:
