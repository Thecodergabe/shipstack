 ...
 */
export type ReturnShippingDocumentFormat = {
    /**
    ...
    /**
     * Specifies the label stock type.  Lists the correct type of paper for the Freight address label option.Specify valid value PAPER_4_PER_PAGE_PORTRAIT<br>Example:PAPER_LETTER
     */
    stockType?: ReturnShippingDocumentFormat.stockType;
    /**
     ...
     */
    docType?: ReturnShippingDocumentFormat.docType;
};
export namespace ReturnShippingDocumentFormat {
    /**
     * Specifies the label stock type.  Lists the correct type of paper for the Freight address label option.Specify valid value PAPER_4_PER_PAGE_PORTRAIT<br>Example:PAPER_LETTER
     */
