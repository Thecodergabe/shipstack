...
/* tslint:disable */
/* eslint-disable */
import type { EmailNotificationRecipient } from './EmailNotificationRecipient';
/**
...
export type EMailNotificationDetail = {
     ...
     */
    aggregationType?: EMailNotificationDetail.aggregationType;
    /**
     * These are email notification recipient details.
     */
    emailNotificationRecipients?: Array<EmailNotificationRecipient>;
    /**
