...
import type { CustomsClearanceDetail_tag } from './CustomsClearanceDetail_tag';
 ...
 */
export type RequestedShipment_tag = {
    /**
     ...
     */
    pickupType: RequestedShipment_tag.pickupType;
    /**
    ...
    customsClearanceDetail?: CustomsClearanceDetail_tag;
...
export namespace RequestedShipment_tag {
    /**
     * Indicates if shipment is being dropped off at a FedEx location or being picked up by FedEx or if it's a regularly scheduled pickup for this shipment. Required for FedEx Express and Ground Shipment.<br>Example: USE_SCHEDULED_PICKUP
     */
