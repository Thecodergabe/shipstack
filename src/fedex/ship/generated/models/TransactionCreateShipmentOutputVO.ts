...
import type { CompletedCreateShipmentDetail } from './CompletedCreateShipmentDetail';
 ...
 */
export type TransactionCreateShipmentOutputVO = {
    /**
    ...
    completedShipmentDetail?: CompletedCreateShipmentDetail;
