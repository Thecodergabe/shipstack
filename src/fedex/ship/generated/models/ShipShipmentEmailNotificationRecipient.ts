 ...
 */
export type ShipShipmentEmailNotificationRecipient = {
    /**
     ...
     */
    notificationFormatType?: ShipShipmentEmailNotificationRecipient.notificationFormatType;
    /**
     * Indicate the type of notification that will be sent as an email<br>Example: EMAIL
     */
    notificationType?: ShipShipmentEmailNotificationRecipient.notificationType;
    /**
     ...
     */
    notificationEventType?: Array<'ON_DELIVERY' | 'ON_EXCEPTION' | 'ON_SHIPMENT' | 'ON_TENDER' | 'ON_ESTIMATED_DELIVERY' | 'ON_PICKUP_DRIVER_ARRIVED' | 'ON_PICKUP_DRIVER_ASSIGNED' | 'ON_PICKUP_DRIVER_DEPARTED' | 'ON_PICKUP_DRIVER_EN_ROUTE'>;
};
export namespace ShipShipmentEmailNotificationRecipient {
    /**
     * This is the email notification recipient type.<br>Example: SHIPPER
     */
