...
/* tslint:disable */
/* eslint-disable */
import type { TransitTimeCommodity } from './TransitTimeCommodity';
/**
 ...
 */
export type TransitTimeRequestedShipment_customsClearanceDetail = {
    /**
     * Specify the commodity details.
     */
    commodities: Array<TransitTimeCommodity>;
};
