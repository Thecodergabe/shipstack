 ...
 */
export type TransitTimeRequestedShipment_shipmentSpecialServices_homeDeliveryPremiumDetail = {
    /**
     ...
     */
    homedeliveryPremiumType?: TransitTimeRequestedShipment_shipmentSpecialServices_homeDeliveryPremiumDetail.homedeliveryPremiumType;
};
export namespace TransitTimeRequestedShipment_shipmentSpecialServices_homeDeliveryPremiumDetail {
    /**
     * This is Home Delivery Premium Type. It allows to specify additional premium service options for the home delivery shipment. Can specify Evening delivery or a Date certain, or can specify appointment for the delivery.
     */
