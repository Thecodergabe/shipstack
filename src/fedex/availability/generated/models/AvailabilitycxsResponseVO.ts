...
/* tslint:disable */
/* eslint-disable */
import type { SpecialServicesOptionsOutputVO } from './SpecialServicesOptionsOutputVO';
/**
 * This is a wrapper class for outputVO
 */
export type AvailabilitycxsResponseVO = {
    /**
    ...
    output?: SpecialServicesOptionsOutputVO;
};
